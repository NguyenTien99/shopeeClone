...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // Cách 1: Lây offsetX, offsetY đơn giản khi ta đã xư lí được bubble event
    const { offsetX, offsetY } = event.nativeEvent
    // Cách 2: Lây offsetX, offsetY khi ta không xữ lí được bubble event
  ...
  const addToCart = () => {
    ...
    // báo lỗi typescript product?.id có thể null có thể ép kiểu string vì biết chắc có product
  }
        ...
        <div className='bg-white p-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              {/* Để hình ảnh chiều dài bằng chiều rộng */}
              <div
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <button
                  onClick={addToCart}
                  className='flex h-12 items-center justify-center rounded-sm border border-orange bg-orange/10 px-5 py-3 capitalize text-orange shadow-sm hover:bg-orange/5'
                >
                  <svg
                ...
                <button
                  className='ml-4 flex h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange px-5 py-3 capitalize text-white shadow-sm outline-none hover:bg-orange/90 '
                  onClick={buyNow}
                >
                  Mua ngay
                </button>
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='bg-white p-4 shadow-sm'>
            ...
            <div className='test-sm mx-4 mb-4 mt-12 leading-loose'>
              <div
